...
1. 二次創作作品の情報が、二次創作作品提出フォーム回答リストの二次創作作品情報確認用シート「二次創作作品情報確認用」に二次創作情報が追加されていくので、Webへの掲載可否を判断し、掲載して良いものは「掲載可否」の欄の数値を1に変更する。
...
1. 「動画除外リスト\_2026春」のスプレッドシートに一覧から除外する動画のIDリストを作成する。
