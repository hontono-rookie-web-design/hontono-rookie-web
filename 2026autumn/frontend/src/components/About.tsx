    ...
    <section id="about" className="w-full py-24 bg-white">
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-sm font-bold tracking-widest text-rose-900 uppercase mb-2">About</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="flex flex-col items-center text-center p-6 bg-base-100 rounded-3xl shadow-sm border border-slate-100 transition-transform hover:-translate-y-1 duration-300">
            ...
            <h4 className="text-xl font-bold text-slate-800 mb-4">初心者の方のための投稿祭です</h4>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-base-100 rounded-3xl shadow-sm border border-slate-100 transition-transform hover:-translate-y-1 duration-300">
            ...
            <p className="text-xs text-slate-500 mt-2">※ 投票は、投稿者以外の方も参加できます。</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-base-100 rounded-3xl shadow-sm border border-slate-100 transition-transform hover:-translate-y-1 duration-300">
            ...
            <h4 className="text-xl font-bold text-slate-800 mb-4">二次創作を強く歓迎しています</h4>

            <p className="text-slate-600 leading-relaxed text-sm">
              <strong>歌ってみた、弾いてみた、踊ってみた、ファンアート、紹介配信など</strong>
              、自由な形で作品を盛り上げてください。
            </p>
          </div>
        </div>
