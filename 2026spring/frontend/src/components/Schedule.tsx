export default function Schedule() {
  const scheduleItems = [
    ...
    },
    {
      ...
      description: "100曲 10Selection。各Discの順位に基づいて振り分け。各Selection上位2作品決勝進出",
      color: "step-accent", // cherry
    },
    {
      title: "決勝(Best)",
    ...
    <section id="schedule" className="w-full py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 text-sm font-medium">※投票状況を見て日程が前後する場合があります</p>
        </div>
        ...
        <div className="mt-16 p-6 md:p-8 bg-slate-50/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-sm max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-5 rounded-xl border border-mint/10 shadow-sm">
              ...
              <p className="text-xs text-slate-400 font-semibold mb-3">2026年4月18日(土) 0:00 〜 4月22日(水) 16:59</p>
              <p className="text-sm text-slate-600 leading-relaxed">
                人気投票には参加せず、純粋に楽曲を聴き合うための事前投稿期間です。
              </p>
            </div>
            <div className="bg-white p-5 rounded-xl border border-cherry/10 shadow-sm">
              ...
              <p className="text-xs text-slate-400 font-semibold mb-3">2026年5月18日(月) 〜 (決勝と同時開催)</p>
              <p className="text-sm text-slate-600 leading-relaxed">
